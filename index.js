 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft=()=>xt().__FIREBASE_DEFAULTS__,jt=()=>{if(typeof process>"u"||typeof process.env>"u")return;const e={}.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},Ht=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&Lt(e[1]);return t&&JSON.parse(t)},Vt=()=>{try{return Ft()||jt()||Ht()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},ze=()=>{var e;return(e=Vt())===null||e===void 0?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt="FirebaseError";class D extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=Wt,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,x.prototype.create)}}class x{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},o=`${this.service}/${t}`,i=this.errors[t],s=i?qt(i,r):"Error",a=`${this.serviceName}: ${s} (${o}).`;return new D(o,a,r)}}function qt(e,t){return e.replace(zt,(n,r)=>{const o=t[r];return o!=null?String(o):`<${r}?>`})}const zt=/\{\$([^}]+)}/g;function te(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const o of n){if(!r.includes(o))return!1;const i=e[o],s=t[o];if(_e(i)&&_e(s)){if(!te(i,s))return!1}else if(i!==s)return!1}for(const o of r)if(!n.includes(o))return!1;return!0}function _e(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(gn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function gn(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const oe="@firebase/app",Ce="0.9.24";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new nn("@firebase/app"),mn="@firebase/app-compat",bn="@firebase/analytics-compat",wn="@firebase/analytics",yn="@firebase/app-check-compat",In="@firebase/app-check",En="@firebase/auth",vn="@firebase/auth-compat",Sn="@firebase/database",_n="@firebase/database-compat",Tn="@firebase/functions",Dn="@firebase/functions-compat",An="@firebase/installations",Cn="@firebase/installations-compat",kn="@firebase/messaging",On="@firebase/messaging-compat",Bn="@firebase/performance",Nn="@firebase/performance-compat",Mn="@firebase/remote-config",$n="@firebase/remote-config-compat",Pn="@firebase/storage",Rn="@firebase/storage-compat",Ln="@firebase/firestore",xn="@firebase/firestore-compat",Fn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ie="[DEFAULT]",jn={[oe]:"fire-core",[mn]:"fire-core-compat",[wn]:"fire-analytics",[bn]:"fire-analytics-compat",[In]:"fire-app-check",[yn]:"fire-app-check-compat",[En]:"fire-auth",[vn]:"fire-auth-compat",[Sn]:"fire-rtdb",[_n]:"fire-rtdb-compat",[Tn]:"fire-fn",[Dn]:"fire-fn-compat",[An]:"fire-iid",[Cn]:"fire-iid-compat",[kn]:"fire-fcm",[On]:"fire-fcm-compat",[Bn]:"fire-perf",[Nn]:"fire-perf-compat",[Mn]:"fire-rc",[$n]:"fire-rc-compat",[Pn]:"fire-gcs",[Rn]:"fire-gcs-compat",[Ln]:"fire-fst",[xn]:"fire-fst-compat","fire-js":"fire-js",[Fn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vn={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},g=new x("app","Firebase",Vn);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kn{constructor(t,n,r){this._isDeleted=!1,this._options=Object.assign({},t),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new w("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw g.create("app-deleted",{appName:this._name})}}function Qe(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:ie,automaticDataCollectionEnabled:!1},t),o=r.name;if(typeof o!="string"||!o)throw g.create("bad-app-name",{appName:String(o)});if(n||(n=ze()),!n)throw g.create("no-options");const i=N.get(o);if(i){if(te(n,i.options)&&te(r,i.config))return i;throw g.create("duplicate-app",{appName:o})}const s=new Xt(o);for(const c of se.values())s.addComponent(c);const a=new Kn(n,r,s);return N.set(o,a),a}function Un(e=ie){const t=N.get(e);if(!t&&e===ie&&ze())return Qe();if(!t)throw g.create("no-app",{appName:e});return t}function m(e,t,n){var r;let o=(r=jn[e])!==null&&r!==void 0?r:e;n&&(o+=`-${n}`);const i=o.match(/\s|\//),s=t.match(/\s|\//);if(i||s){const a=[`Unable to register library "${o}" with version "${t}":`];i&&a.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&a.push("and"),s&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),E.warn(a.join(" "));return}v(new w(`${o}-version`,()=>({library:o,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gn=1024,Jn=30*24*60*60*1e3;class Yn{constructor(t){this.container=t,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Qn(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,n;const o=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Oe();if(!(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(s=>s.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:o}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(s=>{const a=new Date(s.date).valueOf();return Date.now()-a<=Jn}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var t;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Oe(),{heartbeatsToSend:r,unsentEntries:o}=Xn(this._heartbeatsCache.heartbeats),i=qe(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,o.length>0?(this._heartbeatsCache.heartbeats=o,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Oe(){return new Date().toISOString().substring(0,10)}function Xn(e,t=Gn){const n=[];let r=e.slice();for(const o of e){const i=n.find(s=>s.agent===o.agent);if(i){if(i.dates.push(o.date),Be(n)>t){i.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),Be(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class Qn{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ge()?Je().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await zn(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var n;if(await this._canUseIndexedDBPromise){const o=await this.read();return ke(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:o.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var n;if(await this._canUseIndexedDBPromise){const o=await this.read();return ke(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:o.lastSentHeartbeatDate,heartbeats:[...o.heartbeats,...t.heartbeats]})}else return}}function Be(e){return qe(JSON.stringify({version:2,heartbeats:e})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zn(e){v(new w("platform-logger",t=>new pn(t),"PRIVATE")),v(new w("heartbeat",t=>new Yn(t),"PRIVATE")),m(oe,Ce,e),m(oe,Ce,"esm2017"),m("fire-js","")}Zn("");var er="firebase",tr="10.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function me(e){let t;const n=await H(e.appConfig,r=>{const o=Br(r),i=Nr(e,o);return t=i.registrationPromise,i.installationEntry});return n.fid===ue?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Br(e){const t=e||{fid:_r(),registrationStatus:0};return wt(t)}function Nr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(S.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Mr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:$r(e)}:{installationEntry:t}}async function Mr(e,t){try{const n=await Er(e,t);return M(e.appConfig,n)}catch(n){throw at(n)&&n.customData.serverCode===409?await bt(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function $r(e){let t=await Pe(e.appConfig);for(;t.registrationStatus===1;)await ht(100),t=await Pe(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await me(e);return r||n}return t}function Pe(e){return H(e,t=>{if(!t)throw S.create("installation-not-found");return wt(t)})}function wt(e){return Pr(e)?{fid:e.fid,registrationStatus:0}:e}function Pr(e){return e.registrationStatus===1&&e.registrationTime+ot<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rr({appConfig:e,heartbeatServiceProvider:t},n){const r=Lr(e,n),o=wr(e,n),i=t.getImmediate({optional:!0});if(i){const u=await i.getHeartbeatsHeader();u&&o.append("x-firebase-client",u)}const s={installation:{sdkVersion:it,appId:e.appId}},a={method:"POST",headers:o,body:JSON.stringify(s)},c=await ft(()=>fetch(r,a));if(c.ok){const u=await c.json();return ut(u)}else throw await dt("Generate Auth Token",c)}function Lr(e,{fid:t}){return`${ct(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr="/firebase-messaging-sw.js",Zr="/firebase-cloud-messaging-push-scope",Et="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",eo="https://fcmregistrations.googleapis.com/v1",vt="google.c.a.c_id",to="google.c.a.c_l",no="google.c.a.ts",ro="google.c.a.e";var Le;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Le||(Le={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q="fcm_token_details_db",io=5,xe="fcm_token_object_Store";async function so(e){if("databases"in indexedDB&&!(await indexedDB.databases()).map(i=>i.name).includes(Q))return null;let t=null;return(await le(Q,io,{upgrade:async(r,o,i,s)=>{var a;if(o<2||!r.objectStoreNames.contains(xe))return;const c=s.objectStore(xe),u=await c.index("fcmSenderId").get(e);if(await c.clear(),!!u){if(o===2){const d=u;if(!d.auth||!d.p256dh||!d.endpoint)return;t={token:d.fcmToken,createTime:(a=d.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:d.auth,p256dh:d.p256dh,endpoint:d.endpoint,swScope:d.swScope,vapidKey:typeof d.vapidKey=="string"?d.vapidKey:h(d.vapidKey)}}}else if(o===3){const d=u;t={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:h(d.auth),p256dh:h(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:h(d.vapidKey)}}}else if(o===4){const d=u;t={token:d.fcmToken,createTime:d.createTime,subscriptionOptions:{auth:h(d.auth),p256dh:h(d.p256dh),endpoint:d.endpoint,swScope:d.swScope,vapidKey:h(d.vapidKey)}}}}}})).close(),await U(Q),await U("fcm_vapid_details_db"),await U("undefined"),ao(t)?t:null}function ao(e){if(!e||!e.subscriptionOptions)return!1;const{subscriptionOptions:t}=e;return typeof e.createTime=="number"&&e.createTime>0&&typeof e.token=="string"&&e.token.length>0&&typeof t.auth=="string"&&t.auth.length>0&&typeof t.p256dh=="string"&&t.p256dh.length>0&&typeof t.endpoint=="string"&&t.endpoint.length>0&&typeof t.swScope=="string"&&t.swScope.length>0&&typeof t.vapidKey=="string"&&t.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go=7*24*60*60*1e3;async function mo(e){const t=await wo(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:h(t.getKey("auth")),p256dh:h(t.getKey("p256dh"))},r=await St(e.firebaseDependencies);if(r){if(yo(r.subscriptionOptions,n))return Date.now()>=r.createTime+go?bo(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await _t(e.firebaseDependencies,r.token)}catch(o){console.warn(o)}return Fe(e.firebaseDependencies,n)}else return Fe(e.firebaseDependencies,n)}async function Dt(e){const t=await St(e.firebaseDependencies);t&&(await _t(e.firebaseDependencies,t.token),await lo(e.firebaseDependencies));const n=await e.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function bo(e,t){try{const n=await po(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await ye(e.firebaseDependencies,r),n}catch(n){throw await Dt(e),n}}async function Fe(e,t){const r={token:await ho(e,t),createTime:Date.now(),subscriptionOptions:t};return await ye(e,r),r.token}async function wo(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:oo(t)})}function yo(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,o=t.auth===e.auth,i=t.p256dh===e.p256dh;return n&&r&&o&&i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ct(e){try{e.swRegistration=await navigator.serviceWorker.register(Qr,{scope:Zr}),e.swRegistration.update().catch(()=>{})}catch(t){throw f.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo=e=>{const t=new To(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Oo(t,n)),t},No=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>kt(t,r)}};function Mo(){v(new w("messaging",Bo,"PUBLIC")),v(new w("messaging-internal",No,"PRIVATE")),m(He,Ve),m(He,Ve,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Po(e){if(!navigator)throw f.create("only-available-in-window");return e.swRegistration||await Ct(e),Dt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(e=Un()){return $o().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(F(e),"messaging").getImmediate()}async function Ot(e,t){return e=F(e),kt(e,t)}function xo(e){return e=F(e),Po(e)}function Fo(e,t){return e=F(e),Ro(e,t)}Mo();const jo={apiKey:"AIzaSyCzaizV5zcQ0GGLwKnA4IS5K8u7nGVe8rE",authDomain:"fir-96785.firebaseapp.com",projectId:"fir-96785",storageBucket:"fir-96785.appspot.com",messagingSenderId:"910581735460",appId:"1:910581735460:web:0b2c8cf204b55fc4ddb8b1",measurementId:"G-3641HK13M4"},Ho="BMoxRP1fSxLAqFLUC-fFiM1jq0e-LfTMi4bL2q0kG1asRV3Ha3iXBYo4uU42QZ6sCz_SHOcbiYO301d3dev-xYs";Qe(jo);const $=Lo(),Bt="token_div",Nt="permission_div";Fo($,e=>{console.log("Message received. ",e),qo(e)});function Se(){zo(),P("loading...");const e=window.indexedDB;e||console.log("IndexedDB could not be found in this browser.");const t=e.open("firebase-messaging-database",1);t.onerror=function(n){console.error("An error occurred with IndexedDB"),console.error(n)},t.onsuccess=function(){const i=t.result.transaction("firebase-messaging-store","readwrite").objectStore("firebase-messaging-store").getAll();i.onsuccess=()=>{i.result&&i.result.length>0?(console.log("Token was found."),Ke(i.result[0].token)):Ot($,{vapidKey:Ho}).then(s=>{s?(Vo(s),Ke(s)):(console.log("No registration token available. Request permission to generate one."),Go(),R(!1))}).catch(s=>{console.log("An error occurred while retrieving token. ",s),P("Error retrieving registration token."),R(!1)})}}}function P(e){const t=document.querySelector("#token");t.textContent=e}function Vo(e){Ko()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),R(!0))}function Ko(){return window.localStorage.getItem("sentToServer")==="1"}function R(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Uo(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Wo(){Ot($).then(e=>{xo($).then(()=>{console.log("Token deleted.",e),R(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),P("Error retrieving registration token.")})}function qo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function zo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function Ke(e){L(Bt,!0),L(Nt,!1),P(e)}function Go(){L(Bt,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Uo);document.getElementById("delete-token-button").addEventListener("click",Wo);Se();
