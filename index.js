 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ke=function(e){const t=[];let n=0;for(let r=0;r<e.length;r++){let o=e.charCodeAt(r);o<128?t[n++]=o:o<2048?(t[n++]=o>>6|192,t[n++]=o&63|128):(o&64512)===55296&&r+1<e.length&&(e.charCodeAt(r+1)&64512)===56320?(o=65536+((o&1023)<<10)+(e.charCodeAt(++r)&1023),t[n++]=o>>18|240,t[n++]=o>>12&63|128,t[n++]=o>>6&63|128,t[n++]=o&63|128):(t[n++]=o>>12|224,t[n++]=o>>6&63|128,t[n++]=o&63|128)}return t},$t=function(e){const t=[];let n=0,r=0;for(;n<e.length;){const o=e[n++];if(o<128)t[r++]=String.fromCharCode(o);else if(o>191&&o<224){const i=e[n++];t[r++]=String.fromCharCode((o&31)<<6|i&63)}else if(o>239&&o<365){const i=e[n++],s=e[n++],a=e[n++],c=((o&7)<<18|(i&63)<<12|(s&63)<<6|a&63)-65536;t[r++]=String.fromCharCode(55296+(c>>10)),t[r++]=String.fromCharCode(56320+(c&1023))}else{const i=e[n++],s=e[n++];t[r++]=String.fromCharCode((o&15)<<12|(i&63)<<6|s&63)}}return t.join("")},We={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let o=0;o<e.length;o+=3){const i=e[o],s=o+1<e.length,a=s?e[o+1]:0,c=o+2<e.length,u=c?e[o+2]:0,d=i>>2,A=(i&3)<<4|a>>4;let O=(a&15)<<2|u>>6,B=u&63;c||(B=64,s||(O=64)),r.push(n[d],n[A],n[O],n[B])}return r.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(Ke(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):$t(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const n=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let o=0;o<e.length;){const i=n[e.charAt(o++)],a=o<e.length?n[e.charAt(o)]:0;++o;const u=o<e.length?n[e.charAt(o)]:64;++o;const A=o<e.length?n[e.charAt(o)]:64;if(++o,i==null||a==null||u==null||A==null)throw new Pt;const O=i<<2|a>>4;if(r.push(O),u!==64){const B=a<<4&240|u>>2;if(r.push(B),A!==64){const Mt=u<<6&192|A;r.push(Mt)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class Pt extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Rt=function(e){const t=Ke(e);return We.encodeByteArray(t,!0)},qe=function(e){return Rt(e).replace(/\./g,"")},Lt=function(e){try{return We.decodeString(e,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qn(e){v(new w("platform-logger",t=>new pn(t),"PRIVATE")),v(new w("heartbeat",t=>new Yn(t),"PRIVATE")),m(oe,Ce,e),m(oe,Ce,"esm2017"),m("fire-js","")}Qn("");var er="firebase",tr="10.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It="installations",Gr="installations-internal",Jr=e=>{const t=e.getProvider("app").getImmediate(),n=zr(t),r=fe(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Yr=e=>{const t=e.getProvider("app").getImmediate(),n=fe(t,It).getImmediate();return{getId:()=>Kr(n),getToken:o=>Wr(n,o)}};function Xr(){v(new w(It,Jr,"PUBLIC")),v(new w(Gr,Yr,"PRIVATE"))}Xr();m(rt,pe);m(rt,pe,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(e=Kn()){return $o().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(F(e),"messaging").getImmediate()}async function Ot(e,t){return e=F(e),kt(e,t)}function xo(e){return e=F(e),Po(e)}function Fo(e,t){return e=F(e),Ro(e,t)}Mo();const jo={apiKey:"AIzaSyAo9h6jsCxesjI1hF-bVNB9NHmVGHt85Cg",authDomain:"library-35d54.firebaseapp.com",projectId:"library-35d54",storageBucket:"library-35d54.appspot.com",messagingSenderId:"393845927989",appId:"1:393845927989:web:3c0d2269bbe945dea4417c"},Ho="BJv8ySNeZDd2-jLzz68sr05TLGPsBC9wICIoz1Y4HmRqYcZaJXuNDJUyritU31zXG3TeuiBCmLvBMIKkJJ2x-ZQ";Ze(jo);const $=Lo(),Bt="token_div",Nt="permission_div";Fo($,e=>{console.log("Message received. ",e),qo(e)});function Se(){zo(),P("loading...");const e=window.indexedDB;e||console.log("IndexedDB could not be found in this browser.");const t=e.open("firebase-messaging-database",1);t.onerror=function(n){console.error("An error occurred with IndexedDB"),console.error(n)},t.onsuccess=function(){const i=t.result.transaction("firebase-messaging-store","readwrite").objectStore("firebase-messaging-store").getAll();i.onsuccess=()=>{i.result&&i.result.length>0?(console.log("Token was found."),Ue(i.result[0].token)):Ot($,{vapidKey:Ho}).then(s=>{s?(Vo(s),Ue(s)):(console.log("No registration token available. Request permission to generate one."),Go(),R(!1))}).catch(s=>{console.log("An error occurred while retrieving token. ",s),P("Error retrieving registration token."),R(!1)})}}}function P(e){const t=document.querySelector("#token");t.textContent=e}function Vo(e){Uo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),R(!0))}function Uo(){return window.localStorage.getItem("sentToServer")==="1"}function R(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Ko(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Wo(){Ot($).then(e=>{xo($).then(()=>{console.log("Token deleted.",e),R(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),P("Error retrieving registration token.")})}function qo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function zo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function Ue(e){L(Bt,!0),L(Nt,!1),P(e)}function Go(){L(Bt,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Ko);document.getElementById("delete-token-button").addEventListener("click",Wo);Se();
