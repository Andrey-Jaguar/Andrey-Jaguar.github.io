 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new tn("@firebase/app"),gn="@firebase/app-compat",mn="@firebase/analytics-compat",bn="@firebase/analytics",wn="@firebase/app-check-compat",yn="@firebase/app-check",In="@firebase/auth",En="@firebase/auth-compat",vn="@firebase/database",Sn="@firebase/database-compat",_n="@firebase/functions",Tn="@firebase/functions-compat",Dn="@firebase/installations",An="@firebase/installations-compat",Cn="@firebase/messaging",kn="@firebase/messaging-compat",On="@firebase/performance",Bn="@firebase/performance-compat",Nn="@firebase/remote-config",Mn="@firebase/remote-config-compat",$n="@firebase/storage",Pn="@firebase/storage-compat",Rn="@firebase/firestore",Ln="@firebase/firestore-compat",Fn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hn={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},g=new L("app","Firebase",Hn);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function me(e){let t;const n=await j(e.appConfig,r=>{const o=Or(r),i=Br(e,o);return t=i.registrationPromise,i.installationEntry});return n.fid===ue?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Or(e){const t=e||{fid:Sr(),registrationStatus:0};return bt(t)}function Br(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(S.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Nr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:Mr(e)}:{installationEntry:t}}async function Nr(e,t){try{const n=await Ir(e,t);return M(e.appConfig,n)}catch(n){throw st(n)&&n.customData.serverCode===409?await mt(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function Mr(e){let t=await Pe(e.appConfig);for(;t.registrationStatus===1;)await ft(100),t=await Pe(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await me(e);return r||n}return t}function Pe(e){return j(e,t=>{if(!t)throw S.create("installation-not-found");return bt(t)})}function bt(e){return $r(e)?{fid:e.fid,registrationStatus:0}:e}function $r(e){return e.registrationStatus===1&&e.registrationTime+rt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ro(e=Kn()){return Mo().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(F(e),"messaging").getImmediate()}async function kt(e,t){return e=F(e),Ct(e,t)}function Lo(e){return e=F(e),$o(e)}function Fo(e,t){return e=F(e),Po(e,t)}No();const xo={apiKey:"AIzaSyCzaizV5zcQ0GGLwKnA4IS5K8u7nGVe8rE",authDomain:"fir-96785.firebaseapp.com",projectId:"fir-96785",storageBucket:"fir-96785.appspot.com",messagingSenderId:"910581735460",appId:"1:910581735460:web:0b2c8cf204b55fc4ddb8b1",measurementId:"G-3641HK13M4"},jo="BMoxRP1fSxLAqFLUC-fFiM1jq0e-LfTMi4bL2q0kG1asRV3Ha3iXBYo4uU42QZ6sCz_SHOcbiYO301d3dev-xYs";Xe(xo);const $=Ro(),Ot="token_div",Bt="permission_div";Fo($,e=>{console.log("Message received. ",e),qo(e)});function Ho(){kt($,{vapidKey:jo}).then(e=>{e?(Vo(e),Go(e)):(console.log("No registration token available. Request permission to generate one."),Jo(),P(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),H("Error retrieving registration token."),P(!1)})}function Se(){zo(),H("loading..."),Ho()}function H(e){const t=document.querySelector("#token");t.textContent=e}function Vo(e){Ko()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),P(!0))}function Ko(){return window.localStorage.getItem("sentToServer")==="1"}function P(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function R(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Uo(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Wo(){kt($).then(e=>{Lo($).then(()=>{console.log("Token deleted.",e),P(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),H("Error retrieving registration token.")})}function qo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function zo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function Go(e){R(Ot,!0),R(Bt,!1),H(e)}function Jo(){R(Ot,!1),R(Bt,!0)}document.getElementById("request-permission-button").addEventListener("click",Uo);document.getElementById("delete-token-button").addEventListener("click",Wo);Se();
