 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt=()=>Lt().__FIREBASE_DEFAULTS__,Ft=()=>{if(typeof process>"u"||typeof process.env>"u")return;const e={}.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},jt=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&$t(e[1]);return t&&JSON.parse(t)},Ht=()=>{try{return xt()||Ft()||jt()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},qe=()=>{var e;return(e=Ht())===null||e===void 0?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new tn("@firebase/app"),gn="@firebase/app-compat",mn="@firebase/analytics-compat",bn="@firebase/analytics",wn="@firebase/app-check-compat",yn="@firebase/app-check",In="@firebase/auth",En="@firebase/auth-compat",vn="@firebase/database",Sn="@firebase/database-compat",_n="@firebase/functions",Tn="@firebase/functions-compat",Dn="@firebase/installations",An="@firebase/installations-compat",Cn="@firebase/messaging",kn="@firebase/messaging-compat",On="@firebase/performance",Nn="@firebase/performance-compat",Bn="@firebase/remote-config",Mn="@firebase/remote-config-compat",Pn="@firebase/storage",Rn="@firebase/storage-compat",$n="@firebase/firestore",Ln="@firebase/firestore-compat",xn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kn="firebase-heartbeat-database",Wn=1,C="firebase-heartbeat-store";let q=null;function Qe(){return q||(q=le(Kn,Wn,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(C)}}}).catch(e=>{throw g.create("idb-open",{originalErrorMessage:e.message})})),q}async function qn(e){try{return await(await Qe()).transaction(C).objectStore(C).get(Ze(e))}catch(t){if(t instanceof D)E.warn(t.message);else{const n=g.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});E.warn(n.message)}}}async function ke(e,t){try{const r=(await Qe()).transaction(C,"readwrite");await r.objectStore(C).put(t,Ze(e)),await r.done}catch(n){if(n instanceof D)E.warn(n.message);else{const r=g.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});E.warn(r.message)}}}function Ze(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rr({appConfig:e,heartbeatServiceProvider:t},n){const r=$r(e,n),o=br(e,n),i=t.getImmediate({optional:!0});if(i){const u=await i.getHeartbeatsHeader();u&&o.append("x-firebase-client",u)}const s={installation:{sdkVersion:ot,appId:e.appId}},a={method:"POST",headers:o,body:JSON.stringify(s)},c=await lt(()=>fetch(r,a));if(c.ok){const u=await c.json();return ct(u)}else throw await ut("Generate Auth Token",c)}function $r(e,{fid:t}){return`${at(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kr(e,t=!1){const n=e;return await Wr(n),(await be(n,t)).token}async function Wr(e){const{registrationPromise:t}=await me(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Po(e){if(!navigator)throw f.create("only-available-in-window");return e.swRegistration||await At(e),Tt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $o(e=Un()){return Mo().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(F(e),"messaging").getImmediate()}async function kt(e,t){return e=F(e),Ct(e,t)}function Lo(e){return e=F(e),Po(e)}function xo(e,t){return e=F(e),Ro(e,t)}Bo();const Fo={apiKey:"API_KEY",authDomain:"PROJECT_ID.firebaseapp.com",databaseURL:"https://PROJECT_ID.firebaseio.com",projectId:"PROJECT_ID",storageBucket:"PROJECT_ID.appspot.com",messagingSenderId:"SENDER_ID",appId:"APP_ID",measurementId:"G-MEASUREMENT_ID"},jo="BP_u_1QESst8G1EwvJW6BfZ3RtsMg8KlgVPw14slCbTxHfrfy1mc8eW97JzbSp2fVcQ7fLaBHihk6W29wfq8gcU";Xe(Fo);const P=$o(),Ot="token_div",Nt="permission_div";xo(P,e=>{console.log("Message received. ",e),Wo(e)});function Se(){qo(),R("loading..."),kt(P,{vapidKey:jo}).then(e=>{e?(Ho(e),zo(e)):(console.log("No registration token available. Request permission to generate one."),Go(),$(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),R("Error retrieving registration token."),$(!1)})}function R(e){const t=document.querySelector("#token");t.textContent=e}function Ho(e){Vo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),$(!0))}function Vo(){return window.localStorage.getItem("sentToServer")==="1"}function $(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Uo(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Ko(){kt(P).then(e=>{Lo(P).then(()=>{console.log("Token deleted.",e),$(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),R("Error retrieving registration token.")})}function Wo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function qo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function zo(e){L(Ot,!0),L(Nt,!1),R(e)}function Go(){L(Ot,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Uo);document.getElementById("delete-token-button").addEventListener("click",Ko);Se();
